...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			_fnCallbackReg( oSettings, 'aoDrawCallback',       oInit.fnDrawCallback,      'users' );
			_fnCallbackReg( oSettings, 'aoServerParams',       oInit.fnServerParams,      'users' );
			_fnCallbackReg( oSettings, 'aoStateSaveParams',    oInit.fnStateSaveParams,   'users' );
			_fnCallbackReg( oSettings, 'aoStateLoadParams',    oInit.fnStateLoadParams,   'users' );
			_fnCallbackReg( oSettings, 'aoStateLoaded',        oInit.fnStateLoaded,       'users' );
			_fnCallbackReg( oSettings, 'aoRowCallback',        oInit.fnRowCallback,       'users' );
			_fnCallbackReg( oSettings, 'aoRowCreatedCallback', oInit.fnCreatedRow,        'users' );
			_fnCallbackReg( oSettings, 'aoHeaderCallback',     oInit.fnHeaderCallback,    'users' );
			_fnCallbackReg( oSettings, 'aoFooterCallback',     oInit.fnFooterCallback,    'users' );
			_fnCallbackReg( oSettings, 'aoInitComplete',       oInit.fnInitComplete,      'users' );
			_fnCallbackReg( oSettings, 'aoPreDrawCallback',    oInit.fnPreDrawCallback,   'users' );
